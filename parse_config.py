...
if __name__ == "__main__":
   path='/media/sana/c542c407-3f8f-40ee-952e-f0d624d6e507/PhD/Research-work/Cardiac/Algos/Code-In-LabTem/config_train.txt'
   out=parse_config(path)
   config_data= out['data']
   print(config_data)
